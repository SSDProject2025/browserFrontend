                ...
                <span class="flex items-center gap-1">
                  ...
                  Joined {user.joinDate}
                        ...
                        <div class="flex gap-6">
                            ...
                            <div class="text-center">
                                <div class="text-3xl font-bold text-white">{getTotalPlaytime(playedGames)}h</div>
                                <div class="text-sm text-gray-400">Playtime</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-purple-500/20 overflow-hidden">
                        ...
                        <div class="flex gap-6 mt-4">
                            <div class="flex items-center gap-2 text-sm text-gray-400">
                                ...
                                <span>{getTotalPlaytime(collection.games)}h total</span>
                            </div>
                            <div class="flex items-center gap-2 text-sm text-gray-400">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
